<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="View_TEV_C.aspx.cs" Inherits="Approval.View_TEV_C" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <%--<div class="form-group">
                            ...
                            <asp:TextBox ID="txtvotereason" runat="server" ReadOnly="True" class="form-control pull-right"
    ...
    <section class="content container-fluid">
        ...
        <div class="text-center">
            <br /> >
            <div class="form-group">
                <asp:Button ID="btnConfirm" class="btn btn-primary btn-md" runat="server" Text="Confirm" onclick="btnConfirm_Click" onclientclick="javascript:return apply_confim1()" />
                <asp:Button ID="btnConfirm0" class="btn btn-danger btn-md" runat="server" Text="Not Confirm" OnClick="btnConfirm0_Click" />
