<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PardCard.aspx.cs" Inherits="Approval.PardCard" %>
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <br />
                        <asp:Button ID="btcreate" class="btn btn-primary btn-md" runat="server" Text="Create Part Card" OnClick="btcreate_Click" />                        
